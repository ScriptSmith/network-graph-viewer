 ...
 * graph whose nodes wear their logos, and one large enough that reading it
 * means filtering it.
 */
export const SAMPLES: SampleNetwork[] = [SUPERVISION, CHARACTERS, KITCHEN, TOOLCHAIN, CITATIONS];
